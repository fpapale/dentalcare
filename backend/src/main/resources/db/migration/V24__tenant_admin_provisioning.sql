-- V24: aggiorna dentalcare.create_tenant -> l'admin creato in registrazione ha ruolo tenant_admin.
-- Identica a V23 ma l'INSERT del provider admin usa 'tenant_admin' (non 'admin').
-- Cosi' chi registra un nuovo studio entra come amministratore tenant (maschera gestione studi).
