...
--
-- Name: ai_analysis_status; Type: TYPE; Schema: dentalcare; Owner: -
--
...
--
-- Name: ai_review_status; Type: TYPE; Schema: dentalcare; Owner: -
--
...
--
-- Name: ai_label_source; Type: TYPE; Schema: dentalcare; Owner: -
--
...
CREATE VIEW v_patient_dashboard AS
 SELECT p.id AS patient_id,
  ...
  GROUP BY p.id, p.clinic_id, p.first_name, p.last_name, p.fiscal_code_enc, p.fiscal_code_idx, p.phone, p.email, p.city, p.province, p.active;
...
--
-- Name: patient_document_analyses; Type: TABLE; Schema: t_9d754153; Owner: -
--

CREATE TABLE IF NOT EXISTS t_9d754153.patient_document_analyses (
    id uuid PRIMARY KEY DEFAULT gen_random_uuid(),
    clinic_id uuid NOT NULL,
    patient_id uuid NOT NULL,
    document_id uuid NOT NULL,
...
CREATE INDEX IF NOT EXISTS idx_pda_job      ON t_9d754153.patient_document_analyses (job_id);
CREATE INDEX IF NOT EXISTS idx_pda_status   ON t_9d754153.patient_document_analyses (status);


--
-- Name: patient_document_labels; Type: TABLE; Schema: t_9d754153; Owner: -
--

CREATE TABLE IF NOT EXISTS t_9d754153.patient_document_labels (
    id uuid PRIMARY KEY DEFAULT gen_random_uuid(),
    analysis_id uuid NOT NULL REFERENCES t_9d754153.patient_document_analyses (id) ON DELETE CASCADE,
    tooth_fdi text,
    disease text NOT NULL,
    disease_confidence numeric(5,4),
    fdi_confidence numeric(5,4),
...
25	25	create tenant canonical	SQL	V25__create_tenant_canonical.sql	-1661264218	postgres	2026-06-23 21:08:45.038553	282	t
\.
...
33cbe01c-2509-49a9-b8ee-b41bcdce9443	9d754153-6579-4b7e-a56b-025f00299cd9	c1000001-0000-0000-0000-000000000004	b1000001-0000-0000-0000-000000000002	\N	Studio 2	2026-06-26 10:00:00+00	2026-06-26 10:30:00+00	scheduled	Consulto	\N	2026-06-01 19:19:30.690777+00	2026-06-25 08:04:15.977924+00
2746683d-97f6-4d5b-a951-6e637dfb32d6	9d754153-6579-4b7e-a56b-025f00299cd9	c1000001-0000-0000-0000-000000000006	b1000001-0000-0000-0000-000000000002	\N	Studio 2	2026-06-26 12:00:00+00	2026-06-26 12:30:00+00	scheduled	Consulto rapido	\N	2026-06-01 19:19:30.690777+00	2026-06-25 10:48:46.459348+00
\.
...
d2434e8b-ac90-46fa-87ec-460b59c8a415	b170da67-4bc0-4de4-9c4a-16567f0a5d8a	user	anticipa l'appuntamento di Marini per Marchetti di domani di un ora	2026-06-25 09:36:30.706378+00
2f379b52-73c3-49c8-9e64-6283ff3014e4	b170da67-4bc0-4de4-9c4a-16567f0a5d8a	assistant	Non ho trovato un appuntamento per un paziente di nome "Marini" con il dottor Marchetti per domani. Tuttavia, ho trovato questi appuntamenti per il dottor Paolo Marchetti domani:\n\n1. **Romano Luca**\n   - Ora: 09:00 - 10:00\n   - Note: Igiene e pulizia\n\n2. **Colombo Chiara**\n   - Ora: 11:00 - 11:30\n   - Note: Consulto\n\n3. **Ricci Andrea**\n   - Ora: 14:00 - 15:00\n   - Note: Controllo periodico\n\n4. **Marino Valentina**\n   - Ora: 16:00 - 16:30\n   - Note: Consulto rapido\n\nSe hai bisogno di ulteriori dettagli o di effettuare un altro tipo di modifica, fammi sapere!	2026-06-25 09:36:34.698861+00
b6943104-0a86-4608-9a21-88184dfb6aec	b170da67-4bc0-4de4-9c4a-16567f0a5d8a	user	anticipa l'appuntamento di Marino per Marchetti di domani di un ora	2026-06-25 09:36:54.841396+00
474b8822-5e56-4f97-be5d-9c0a3a23090f	b170da67-4bc0-4de4-9c4a-16567f0a5d8a	assistant	Ho preparato l'anteprima per anticipare l'appuntamento di Valentina Marino con il dottor Paolo Marchetti da domani alle 16:00 a domani alle 15:00.\n\n- **Data e Ora Nuova**: 26 giugno 2026 alle 15:00\n- **Durata**: 30 minuti\n- **Studio**: Studio 2\n- **Medico**: Paolo Marchetti\n\nPosso procedere con la conferma dello spostamento?	2026-06-25 09:36:59.033114+00
6d1c9837-c1ac-4f7a-b87d-dd6e2bc87fc7	b170da67-4bc0-4de4-9c4a-16567f0a5d8a	user	conferma lo spostamento	2026-06-25 09:37:13.689878+00
c607d073-964e-40aa-845c-ab81d1553662	b170da67-4bc0-4de4-9c4a-16567f0a5d8a	assistant	Mi scuso per l'inconveniente. Sembra che ci sia un problema nel recuperare correttamente l'appuntamento da spostare. Ti consiglio di verificare i dettagli dell'appuntamento e riprovare. Se hai altre richieste o domande, sono qui per aiutarti.	2026-06-25 09:37:17.719526+00
19b5560c-7125-419c-ad72-836dd602c8da	976a69b9-08ce-4f16-8ea5-19a3d608ec78	user	anticipa l'appuntamento di Marino per Marchetti di domani di un ora	2026-06-25 09:56:03.988892+00
a6e1f8be-adbd-4f2e-8d2a-d57b10d6cbea	976a69b9-08ce-4f16-8ea5-19a3d608ec78	assistant	Il medico Paolo Marchetti ha già un appuntamento previsto per le 15:00. Gli orari disponibili per anticipare l'appuntamento di Valentina Marino sono:\n\n- 09:00\n- 09:15\n- 09:30\n- 11:00\n- 11:15\n\nQuale di questi preferisci?	2026-06-25 09:56:09.435392+00
54213ef8-149e-4708-b64e-f462d30eb8dd	976a69b9-08ce-4f16-8ea5-19a3d608ec78	user	che disponibilità h domani Marino?	2026-06-25 09:57:18.091767+00
b9584ea8-2202-4d86-92f8-7ab90df1a353	976a69b9-08ce-4f16-8ea5-19a3d608ec78	assistant	Non sono riuscita a trovare una paziente di nome Valentina Marino nel nostro database. Potresti controllare se il nome è corretto o fornire ulteriori dettagli per aiutarmi nella ricerca?	2026-06-25 09:57:20.976791+00
438ffcb6-de38-4ad0-a919-6a5c318912d0	976a69b9-08ce-4f16-8ea5-19a3d608ec78	user	Che disponibilità ha domani Marchertti	2026-06-25 09:57:40.039835+00
998b5c99-6355-4dc9-b081-faa2441ac4ba	976a69b9-08ce-4f16-8ea5-19a3d608ec78	assistant	Domani, il dottor Paolo Marchetti ha i seguenti orari disponibili:\n\n- Mattina:\n  - 09:00\n  - 09:15\n  - 09:30\n  - 11:00\n  - 11:15\n  - 11:30\n  - 12:30\n\n- Pomeriggio:\n  - 14:00\n  - 14:15\n  - 14:30\n  - 16:00\n  - 16:15\n  - 16:30\n  - 17:30\n  - 17:45\n  - 18:00\n  - 18:15\n  - 18:30\n\nSe desideri fissare un appuntamento, fammi sapere quale orario preferisci!	2026-06-25 09:57:44.360328+00
2f246b8d-61e7-47ee-97e2-77b8ea659d7f	976a69b9-08ce-4f16-8ea5-19a3d608ec78	user	anticipa l'appuntamento di Marino per Marchetti di domani di un ora almeno. Scegli tu il miglior orario	2026-06-25 09:58:39.5856+00
4fb40d61-9893-460c-8929-e2c955966d21	976a69b9-08ce-4f16-8ea5-19a3d608ec78	assistant	Ho preparato l'anteprima per lo spostamento dell'appuntamento di Valentina Marino al 26 giugno 2026 alle 09:00 (durata 30 minuti, Studio 2).\n\nVuoi confermare questa modifica?	2026-06-25 09:58:45.370701+00
0259598a-0a7c-4ed4-9367-de1c74269659	976a69b9-08ce-4f16-8ea5-19a3d608ec78	user	più tardi nel pomeriggio?	2026-06-25 09:59:06.317265+00
1d2a421c-24a0-492c-8fce-78f039f4515f	976a69b9-08ce-4f16-8ea5-19a3d608ec78	assistant	Ho preparato l'anteprima per lo spostamento dell'appuntamento di Valentina Marino al 26 giugno 2026 alle 16:00 (durata 30 minuti, Studio 2).\n\nVuoi confermare questa modifica?	2026-06-25 09:59:11.880233+00
44322ef9-7ea5-487a-9127-ce85650a5b9d	976a69b9-08ce-4f16-8ea5-19a3d608ec78	user	Va bene	2026-06-25 09:59:19.460733+00
6db7330d-493a-4749-acef-b00b4bee25b5	976a69b9-08ce-4f16-8ea5-19a3d608ec78	assistant	Sembra che ci sia stato un problema nel trovare l'appuntamento specificato. Ti chiedo gentilmente di fornire ulteriori dettagli o di verificare le informazioni dell'appuntamento che desideri modificare. Potresti anche specificare un altro orario o un'altra poltrona se necessario.	2026-06-25 09:59:24.099343+00
409507a2-b239-4c5c-9154-b76f2dbcc16a	976a69b9-08ce-4f16-8ea5-19a3d608ec78	user	anche un'altra poltrona	2026-06-25 10:00:04.176936+00
8aec2e82-f06b-424a-86c6-8fb1d08c29c7	976a69b9-08ce-4f16-8ea5-19a3d608ec78	assistant	Ho riscontrato che lo Studio 1 è già occupato alle 16:00. Le poltrone disponibili a quell'ora sono:\n\n- Poltrona 1\n- Poltrona 2\n- Poltrona 3\n- Poltrona 4\n- Studio 2\n- Studio 4\n\nVuoi spostare l'appuntamento in una di queste poltrone?	2026-06-25 10:00:08.311472+00
0067e1b7-90db-43f4-8aec-7e50eebfeb09	976a69b9-08ce-4f16-8ea5-19a3d608ec78	user	Studio 2	2026-06-25 10:00:36.199412+00
5975efb4-9fae-4f4f-953e-ee40868e1ab4	976a69b9-08ce-4f16-8ea5-19a3d608ec78	assistant	Ho preparato l'anteprima per lo spostamento dell'appuntamento di Valentina Marino al 26 giugno 2026 alle 16:00 nello Studio 2.\n\nVuoi confermare questa modifica?	2026-06-25 10:00:39.954658+00
f7f7d5fb-1fe4-4402-87bd-fc83c9d0ff65	976a69b9-08ce-4f16-8ea5-19a3d608ec78	user	confermo	2026-06-25 10:00:46.047199+00
f42d94f3-f56b-4fac-bcc3-b7f113693d90	976a69b9-08ce-4f16-8ea5-19a3d608ec78	assistant	L'appuntamento di Valentina Marino è stato spostato con successo al 26 giugno 2026 alle 16:00 nello Studio 2 con il dottor Paolo Marchetti. Se hai bisogno di ulteriore assistenza, non esitare a chiedere!	2026-06-25 10:00:54.448693+00
08f8295b-8a86-4d3c-bc56-3c5350a3b26e	0390774b-4617-4863-bbe9-5972c7bcad0e	user	anticipa Valentina a domani alle 16:00	2026-06-25 10:10:41.784996+00
5121a1d8-540b-46f2-a5d8-893069d0bf12	0390774b-4617-4863-bbe9-5972c7bcad0e	assistant	Per anticipare correttamente l'appuntamento di Valentina a domani alle 16:00, ho bisogno di sapere quale appuntamento specifico desideri spostare. Puoi fornirmi ulteriori dettagli, come la tipologia del trattamento o il nome del medico?	2026-06-25 10:10:43.811187+00
6d27771d-19d5-46cf-b769-9fbbe6ee4cf3	976a69b9-08ce-4f16-8ea5-19a3d608ec78	user	anticipa l'appuntamento di Marino per Marchetti di domani di un ora almeno. Scegli tu il miglior orario	2026-06-25 10:12:14.30804+00
aa1e07fb-1531-4852-8537-f4343776ef4c	976a69b9-08ce-4f16-8ea5-19a3d608ec78	assistant	Ho preparato l'anteprima per lo spostamento dell'appuntamento di Valentina Marino al 26 giugno 2026 alle 17:00 nello Studio 2.\n\nVuoi confermare questa modifica?	2026-06-25 10:12:18.418565+00
e06727fb-8571-48c2-ad5d-db8717284198	976a69b9-08ce-4f16-8ea5-19a3d608ec78	user	si	2026-06-25 10:12:24.9621+00
0bdd5940-6e42-4004-833b-cf4d9b761216	976a69b9-08ce-4f16-8ea5-19a3d608ec78	assistant	L'appuntamento di Valentina Marino è stato anticipato con successo al 26 giugno 2026 alle 17:00 nello Studio 2 con il dottor Paolo Marchetti. Se hai bisogno di ulteriore assistenza, fammi sapere!	2026-06-25 10:12:28.869387+00
109ba865-834a-4fcb-846e-e635f7fc70d2	976a69b9-08ce-4f16-8ea5-19a3d608ec78	user	anticipa l'appuntamento di Marino per Marchetti di domani di un ora almeno. Scegli tu il miglior orario	2026-06-25 10:13:17.629775+00
28615fcc-59dd-483c-ac60-174fa0f568ce	976a69b9-08ce-4f16-8ea5-19a3d608ec78	assistant	Ho preparato l'anteprima per lo spostamento dell'appuntamento di Valentina Marino al 26 giugno 2026 alle 17:00 nello Studio 2.\n\nVuoi confermare questa modifica?	2026-06-25 10:13:28.773888+00
3c82a366-69ad-4b8f-bd98-661ef973c505	976a69b9-08ce-4f16-8ea5-19a3d608ec78	user	no	2026-06-25 10:13:54.006977+00
6d64493a-36d0-495c-bbdb-26b839ffc0e6	976a69b9-08ce-4f16-8ea5-19a3d608ec78	assistant	L'operazione è stata annullata. Se desideri scegliere un altro orario o hai bisogno di ulteriore assistenza, fammi sapere!	2026-06-25 10:13:55.32503+00
ffe200dd-216a-4f6a-bf2c-e0be626f3b39	976a69b9-08ce-4f16-8ea5-19a3d608ec78	user	a che ora ha l'appuntamento domani AMrino?	2026-06-25 10:14:08.423035+00
552c4fc4-0e55-4afd-9a5d-d9da5f5c921c	976a69b9-08ce-4f16-8ea5-19a3d608ec78	assistant	L'appuntamento di Valentina Marino con il dottor Paolo Marchetti è fissato per domani, 26 giugno 2026, alle 17:00 nello Studio 2.\n\nSe desideri anticipare l'appuntamento, fammi sapere l'orario che preferisci o se vuoi che scelga io un nuovo orario disponibile!	2026-06-25 10:14:11.199538+00
86e49126-11ce-4772-8f08-b2a33abd1910	976a69b9-08ce-4f16-8ea5-19a3d608ec78	user	Scegli tu	2026-06-25 10:14:22.286723+00
1f04f028-831c-4a1e-9796-292a8cdbb630	976a69b9-08ce-4f16-8ea5-19a3d608ec78	assistant	Sembra che ci sia un problema con l'identificazione dell'appuntamento di Valentina Marino. Potresti verificare le informazioni o fornire ulteriori dettagli sull'appuntamento che desideri modificare?	2026-06-25 10:14:26.398636+00
ea611b74-6f04-4d01-89b8-90952d511556	a9d6f460-3bdf-48f2-86ac-6b4f29775f48	user	Anticipa l'appuntamento di Valentina Marino di domani. Scegli tu un orario libero del medico.	2026-06-25 10:15:55.053651+00
db4c4681-c2dd-47f6-b93d-be8da674dd85	a9d6f460-3bdf-48f2-86ac-6b4f29775f48	assistant	Non riesco a trovare una paziente di nome Valentina Marino nel nostro database. Potresti controllare se il nome è corretto o fornire ulteriori dettagli, come un numero di telefono o un'email associati al paziente?	2026-06-25 10:15:57.814327+00
332be450-3380-4f14-b2c3-6c25eb1c459d	0e79da2b-553d-4b17-ad73-075a364d9a7b	user	Scegli tu	2026-06-25 10:16:33.968943+00
39d4a8d3-94ca-44da-8dca-2ebf9f803d33	0e79da2b-553d-4b17-ad73-075a364d9a7b	assistant	Ecco le fasce orarie disponibili per domani, 26 giugno 2026, con il dottor Paolo Marchetti:\n\n- Mattina: 09:00, 09:15, 09:30, 11:00, 11:15, 11:30, 12:30\n- Pomeriggio: 14:00, 14:15, 14:30, 16:00, 16:15, 16:30, 17:30, 17:45, 18:00, 18:15, 18:30\n\nPuoi scegliere uno di questi orari per l'appuntamento di Valentina Marino. Fammi sapere quale preferisci!	2026-06-25 10:16:38.758318+00
1451bff2-3157-4b6c-8726-66cbf2e8812b	01c57ce0-9303-4774-85b1-355a40aed542	user	Va bene le 16:00	2026-06-25 10:17:03.66534+00
9b42b798-3bea-4324-91b3-c1f79da252c3	01c57ce0-9303-4774-85b1-355a40aed542	assistant	Sembra che ci sia stato un problema con l'identificazione dell'appuntamento di Valentina Marino. Potresti confermarmi i dettagli per verificare nuovamente?	2026-06-25 10:17:06.250825+00
61254e01-97ae-4226-bf5b-8a4abc1dde44	d05879b4-2a79-4659-be69-e7e822b2e664	user	Va bene le 16:00	2026-06-25 10:19:38.792456+00
e15edb22-aace-4d91-8604-32cb4d3a0ec1	d05879b4-2a79-4659-be69-e7e822b2e664	assistant	Ecco l'anteprima dello spostamento dell'appuntamento:\n\n- **Data e Ora:** 26 giugno 2026 alle 16:00\n- **Durata:** 30 minuti\n- **Studio:** Studio 2\n\nVuoi confermare questo spostamento?	2026-06-25 10:19:46.330613+00
4dddc36a-b93b-43d9-b919-7fd976c67a8b	48fb4c42-99c2-4f5d-80c6-84bb7119cacf	user	Va bene	2026-06-25 10:20:17.750682+00
238b6fa2-085b-4078-9b0e-0ad00d0666eb	48fb4c42-99c2-4f5d-80c6-84bb7119cacf	assistant	L'appuntamento di Valentina Marino è stato spostato a domani, 26 giugno 2026, alle 16:00 nello Studio 2.	2026-06-25 10:20:20.30719+00
cd7cc0fd-03f1-4464-aae8-be22aa1aae11	37e8fb0f-12f3-4541-813f-6f6cbd16d0b0	user	Anticipa l'appuntamento di Valentina di domani alle 14:00	2026-06-25 10:22:44.609816+00
3a7ad858-4905-41ab-9895-e7ed685c75e1	37e8fb0f-12f3-4541-813f-6f6cbd16d0b0	assistant	Il medico non è disponibile per anticipare l'appuntamento di Valentina domani alle 11:00. Gli orari disponibili per il medico sono:\n\n- 12:30\n- 15:00\n- 15:15\n- 15:30\n- 17:00\n\nFammi sapere quale orario preferisci!	2026-06-25 10:22:48.436665+00
69509af2-577e-46f6-a906-6e88e6e95b7d	b2e7df3c-2447-41df-ba6c-69b047ea3bd4	user	Anticipa l'appuntamento di Valentina Marino di domani alle 14:00	2026-06-25 10:24:54.038708+00
cc076114-7f7a-405e-9be7-0730e9dbdd05	b2e7df3c-2447-41df-ba6c-69b047ea3bd4	assistant	Il medico, Paolo Marchetti, non è disponibile oggi alle 11:00. Gli orari liberi disponibili per oggi sono:\n\n- 12:30\n- 15:00\n- 15:15\n- 15:30\n- 17:00\n\nFammi sapere quale orario preferisci per anticipare l'appuntamento di Valentina Marino.	2026-06-25 10:24:59.593191+00
1aaf0761-3d3b-4221-a9c1-2870b33cf7f3	08e1c830-cded-424f-b915-903f610840a0	user	Anticipa l'appuntamento di Valentina Marino di domani alle 14:00	2026-06-25 10:46:23.045634+00
db78aae4-a52b-4c3e-b2a9-d5f3f1e58abd	08e1c830-cded-424f-b915-903f610840a0	assistant	Ecco l'anteprima per l'appuntamento di Valentina Marino:\n\n- **Nuova Data e Ora:** 26 giugno 2026 alle 14:00\n- **Durata:** 30 minuti\n- **Studio:** Studio 2\n- **Medico:** Paolo Marchetti\n\nPosso procedere con la conferma?	2026-06-25 10:46:29.768272+00
8cf03708-8ca3-4907-afdc-fef206e6a27f	2782de18-eb9c-4130-869b-63c4ec15c5a0	user	Sposta l'appuntamento di Valentina Marino di domani alle 15:00	2026-06-25 10:46:43.617282+00
be1859ff-31f4-4960-b1f9-2782203f5fff	2782de18-eb9c-4130-869b-63c4ec15c5a0	assistant	Il medico non è disponibile domani alle 15:00. Gli orari liberi del medico per il 26 giugno 2026 sono:\n\n- 09:00\n- 09:15\n- 09:30\n- 11:00\n- 11:15\n\nFammi sapere quale preferisci per spostare l'appuntamento di Valentina Marino.	2026-06-25 10:46:49.241849+00
26d1bd14-ca73-4ffe-95cd-a0bba86c9fed	e9fbfc0e-e415-432d-b4bb-b0544e3fc222	user	Sposta l'appuntamento di Valentina Marino di domani alle 14:00	2026-06-25 10:48:35.989341+00
751a2623-bf6d-44bd-8f5d-c2a7fb290588	e9fbfc0e-e415-432d-b4bb-b0544e3fc222	assistant	Ho preparato l'anteprima per lo spostamento dell'appuntamento di Valentina Marino. Ecco i dettagli:\n\n- **Data:** 2026-06-26\n- **Ora:** 14:00\n- **Durata:** 30 minuti\n- **Studio:** Studio 2\n\nVuoi confermare lo spostamento?	2026-06-25 10:48:40.17133+00
ecb60394-ef01-4bf3-a71b-53dd015274a1	e9fbfc0e-e415-432d-b4bb-b0544e3fc222	user	si	2026-06-25 10:48:44.877399+00
736aa27a-13db-4f25-b42e-81b139f547e1	e9fbfc0e-e415-432d-b4bb-b0544e3fc222	assistant	L'appuntamento di Valentina Marino è stato spostato con successo a domani, 26 giugno 2026, alle 14:00. Se hai bisogno di ulteriori informazioni o assistenza, fammi sapere!	2026-06-25 10:48:47.852761+00
\.
...
48fb4c42-99c2-4f5d-80c6-84bb7119cacf	5cac268e-1fdd-4d13-966c-65e367dca1c8	Va bene	2	2026-06-25 10:20:17.659635+00	2026-06-25 10:20:20.30719+00
37e8fb0f-12f3-4541-813f-6f6cbd16d0b0	5cac268e-1fdd-4d13-966c-65e367dca1c8	Anticipa l'appuntamento di Valentina di domani alle 14:00	2	2026-06-25 10:22:44.515822+00	2026-06-25 10:22:48.436665+00
b170da67-4bc0-4de4-9c4a-16567f0a5d8a	5cac268e-1fdd-4d13-966c-65e367dca1c8	anticipa l'appuntamento di Marini per Marchetti di domani di…	6	2026-06-25 09:36:30.606325+00	2026-06-25 09:37:17.719526+00
b2e7df3c-2447-41df-ba6c-69b047ea3bd4	5cac268e-1fdd-4d13-966c-65e367dca1c8	Anticipa l'appuntamento di Valentina Marino di domani alle 1…	2	2026-06-25 10:24:53.944151+00	2026-06-25 10:24:59.593191+00
08e1c830-cded-424f-b915-903f610840a0	5cac268e-1fdd-4d13-966c-65e367dca1c8	Anticipa l'appuntamento di Valentina Marino di domani alle 1…	2	2026-06-25 10:46:22.951271+00	2026-06-25 10:46:29.768272+00
2782de18-eb9c-4130-869b-63c4ec15c5a0	5cac268e-1fdd-4d13-966c-65e367dca1c8	Sposta l'appuntamento di Valentina Marino di domani alle 15:…	2	2026-06-25 10:46:43.528299+00	2026-06-25 10:46:49.241849+00
e9fbfc0e-e415-432d-b4bb-b0544e3fc222	5cac268e-1fdd-4d13-966c-65e367dca1c8	Sposta l'appuntamento di Valentina Marino di domani alle 14:…	4	2026-06-25 10:48:35.900797+00	2026-06-25 10:48:47.852761+00
0390774b-4617-4863-bbe9-5972c7bcad0e	5cac268e-1fdd-4d13-966c-65e367dca1c8	anticipa Valentina a domani alle 16:00	2	2026-06-25 10:10:41.69109+00	2026-06-25 10:10:43.811187+00
976a69b9-08ce-4f16-8ea5-19a3d608ec78	5cac268e-1fdd-4d13-966c-65e367dca1c8	anticipa l'appuntamento di Marino per Marchetti di domani di…	30	2026-06-25 09:56:03.893919+00	2026-06-25 10:14:26.398636+00
a9d6f460-3bdf-48f2-86ac-6b4f29775f48	5cac268e-1fdd-4d13-966c-65e367dca1c8	Anticipa l'appuntamento di Valentina Marino di domani. Scegl…	2	2026-06-25 10:15:54.964059+00	2026-06-25 10:15:57.814327+00
0e79da2b-553d-4b17-ad73-075a364d9a7b	5cac268e-1fdd-4d13-966c-65e367dca1c8	Scegli tu	2	2026-06-25 10:16:33.867721+00	2026-06-25 10:16:38.758318+00
01c57ce0-9303-4774-85b1-355a40aed542	5cac268e-1fdd-4d13-966c-65e367dca1c8	Va bene le 16:00	2	2026-06-25 10:17:03.571755+00	2026-06-25 10:17:06.250825+00
d05879b4-2a79-4659-be69-e7e822b2e664	5cac268e-1fdd-4d13-966c-65e367dca1c8	Va bene le 16:00	2	2026-06-25 10:19:38.688867+00	2026-06-25 10:19:46.330613+00
\.
...
a09fd284-3288-4bd9-91b4-56b17cea1d7c	9d754153-6579-4b7e-a56b-025f00299cd9	c1000001-0000-0000-0000-000000000003	\N	b1000001-0000-0000-0000-000000000002	rx_panoramica	Ortopantomografia inquadramento	\N	ortopan_romano_2024.jpg	patients/c1000001-0000-0000-0000-000000000003/a09fd284-3288-4bd9-91b4-56b17cea1d7c/ortopan_romano_2024.jpg	\N	image/jpeg	\N	\N	Ortopantomografia di inquadramento	2026-05-04 08:30:00+00	2026-05-29 13:52:49.31794+00
...
10dd504a-44ee-4263-b341-4e113b9040c3	9d754153-6579-4b7e-a56b-025f00299cd9	c1000001-0000-0000-0000-000000000007	\N	b1000001-0000-0000-0000-000000000003	rx_panoramica	OPT pre-trattamento ortodontico	\N	ortopan_greco_pre_orto.jpg	patients/c1000001-0000-0000-0000-000000000007/10dd504a-44ee-4263-b341-4e113b9040c3/ortopan_greco_pre_orto.jpg	\N	image/jpeg	\N	\N	OPT pre-trattamento ortodontico	2025-08-02 09:00:00+00	2026-05-29 13:52:49.31794+00
...
97f8c12d-5dab-4ac4-82a3-01a356864419	9d754153-6579-4b7e-a56b-025f00299cd9	Papale	Giulia	pplgli97d66h501q	1997-04-26	+390651958086	Via Millevoi 801	\N	Roma	RM	00178	IT	\N	2026-06-25 14:06:55.587603+00	2026-06-25 14:06:55.587603+00	\N	giulia.papale@gmail.com	t	b1000001-0000-0000-0000-000000000003
c1000001-0000-0000-0000-000000000008	9d754153-6579-4b7e-a56b-025f00299cd9	Francesca	Bruno	BRNFNC95H48H501S	1995-08-30	+39 348 1110008	\N	\N	Roma	RM	00167	IT	\N	2026-05-29 13:52:49.31794+00	2026-06-25 14:15:22.250583+00	\N	\N	t	\N
\.
