...
-- Medico di riferimento del paziente (FK qui: providers ora esiste)
ALTER TABLE patients ADD COLUMN IF NOT EXISTS primary_provider_id uuid;
ALTER TABLE patients
...
CREATE TABLE IF NOT EXISTS patient_recalls (
    ...
    status                dentalcare.recall_status  NOT NULL DEFAULT 'pending',
    priority              dentalcare.recall_priority NOT NULL DEFAULT 'medium',
    notes                 text,
...
CREATE TABLE IF NOT EXISTS recall_contacts (
    ...
    contact_type           dentalcare.recall_contact_type NOT NULL DEFAULT 'phone',
